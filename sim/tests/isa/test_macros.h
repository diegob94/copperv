...
#define TEST_CASE( testnum, testreg, correctval, code... ) \
  _TEST_CASE(INSTRUCTION_ID, testnum, testreg, correctval, code)

#define _TEST_CASE(...) __TEST_CASE(__VA_ARGS__)

#define __TEST_CASE( instruction_id, testnum, testreg, correctval, code... ) \
test_ ## instruction_id ## _ ## testnum: \
    code; \
    li  x7, MASK_XLEN(correctval); \
    li  TESTNUM, (((instruction_id & 0xFFFF) << 16) | (testnum & 0xFFFF)); \
    bne testreg, x7, fail;
